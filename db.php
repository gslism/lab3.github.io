...
try {
    $stmt = $db->prepare("INSERT INTO forma_zapisi2 (full_name, phone,email,birth_date,gender,lange_name,bio,contract_agreed) VALUES ('$login','$tel','$email','$date','$someGroupName','$bio','$checkt','".implode(",", $lange)."')");
    $login = $_POST['login'];
    $email = $_POST['email'];
    $tel = $_POST['tel'];
    $date = $_POST['date'];
